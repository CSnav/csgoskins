...
class GunSkin(models.Model):
    ...
    weapon_type = models.CharField(max_length=20, default="", choices=WT_CHOICES)
    gun_type = models.CharField(max_length=30, default="", choices=GT_CHOICES)
    exterior = models.CharField(max_length=30, choices=EX_CHOICES)
...
class KnifeSkin(models.Model):
    ...
    icon_url = models.CharField(max_length=300)
    icon_url_large = models.CharField(max_length=300)
    weapon_type = models.CharField(max_length=10, choices=WT_CHOICES)
